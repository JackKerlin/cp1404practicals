...
larger_nine_numbers = [number for number in numbers if number > 9]
print(larger_nine_numbers)
...
larger_eleven_last_names = [name.split()[1] for name in full_names if len(name) > 11]
larger_eleven_last_names = ", ".join(larger_eleven_last_names)
print(larger_eleven_last_names)