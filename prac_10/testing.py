...
def format_phrase(phrase):
    """
    Format a phrase to have a capital at the start and a full stop at the end
    >>> format_phrase("hello")
    'Hello.'
    >>> format_phrase("It is an ex parrot.")
    'It is an ex parrot.'
    >>> format_phrase("a long time.")
    'A long time.'
    """
    split_phrase = phrase.split()
    # Sets the first word to be title case.
    split_phrase[0] = split_phrase[0].title()
    if split_phrase[-1][-1] != ".":
        split_phrase[-1] += "."
